...
try:
ticker = client.get_ticker(market='btc-usdt')
...
| `get_ticker` | <ul><li>**symbol**: HollaEx trading symbol e.g. `btc-usdt`</li></ul> | Last, high, low, open and close price and volume within the last 24 hours |
| `get_tickers` | | Last, high, low, open and close price and volume within the last 24 hours for all symbols |
| `get_rderbook` | <ul><li>**symbol**: HollaEx trading symbol e.g. `btc-usdt`</li></ul> | Orderbook containing list of bids and asks |
| `get_orderbooks` | | Orderbook containing list of bids and asks for all symbols |
| `get_trades` | <ul><li>**opts**: Object with additional params</li><li>**opts.symbol**: (_optional_) HollaEx trading symbol e.g. `btc-usdt`</li></ul> | List of last trades |
